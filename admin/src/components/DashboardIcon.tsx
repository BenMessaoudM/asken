...
const paths: Record<IconName, string> = {
  ...
  organization: 'M12 3 4 7v10l8 4 8-4V7l-8-4Zm0 0v18M4 7l8 4 8-4M8 13h2m4 0h2M8 16h2m4 0h2',
  governance: 'M3 10h18M5 10v8m4-8v8m6-8v8m4-8v8M2 21h20M12 2 3 7h18l-9-5Z',
  appearance: 'M12 3c3.5 0 7 2.1 7 5.8 0 2.8-2.2 3-3 3h-1.2c-.8 0-1.3.8-.9 1.5.4.8 1 1.4 1 2.5 0 2-1.8 3.2-4 3.2-4.4 0-8-3.4-8-7.7C3 6.7 7 3 12 3Zm-4 6h.01M11 7h.01M15 8h.01M7 13h.01',
