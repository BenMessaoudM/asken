...
export const defaultBookingCategories: BookingCategoryInput[] = [
  ...
  { key: 'arcada_association', name: { sv: 'Arcadaförening', en: 'Arcada Association', fi: 'Arcadan yhdistys' }, description: { sv: 'Registrerade Arcadaföreningar.', en: 'Registered Arcada associations.', fi: 'Rekisteröidyt Arcadan yhdistykset.' }, active: true, displayOrder: 20, billingAddressRequired: false, contractRequired: false, quoteRequestAllowed: true, public: true },
