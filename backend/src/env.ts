...
const envSchema = z.object({
  ...
  COR_HOUSE_DOOR_CODE: z.string().trim().min(1).optional(),
  COR_HOUSE_LANDLORD_ADDRESS: z.string().trim().min(1).optional(),
  COR_HOUSE_LANDLORD_EMAIL: z.string().email().optional(),
  COR_HOUSE_BOARD_MEMBER_EMAILS: z.string().optional(),
